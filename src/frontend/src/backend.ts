...
import type { Feedback as _Feedback } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFeedbackById(arg0: bigint): Promise<Feedback | null> {
        if (this.processError) {
            try {
    ...
    async submitFeedback(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Feedback]): Feedback | null {
